  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white font-semibold shadow-button hover:shadow-glow hover:scale-105 transition-bounce",
        gradient: "bg-gradient-accent text-white font-medium shadow-button hover:shadow-glow hover:scale-[1.02] transition-smooth",
        glass: "bg-glass-bg backdrop-blur-sm border border-glass-border text-foreground hover:bg-glass-bg/90 hover:border-accent/30",
      },
      size: {
